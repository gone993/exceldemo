...
public class ExcelUploadController {
    ...
    public String readExcel(@RequestParam("file") MultipartFile file, Model model)
        ...
        String[] strCtegryDessert = {"후식", "후식", "후식", "후식", "후식"};
...
//                        }
        ...
        List<String> list4 = new ArrayList(Arrays.asList(strCtegryDessert));
        list3.addAll(list4);
    ...
    list4 = new ArrayList(Arrays.asList(strCtegryDessert));
    list3.addAll(list4);
